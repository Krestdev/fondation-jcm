...
function Navbar() {
  ...
  return (
    <div className='w-full h-20 inline-flex items-center justify-center'>
        <div className='inline-flex w-full max-w-screen-xl px-7 items-center justify-between border-b border-gray-300 h-full'>
            ...
            <Link href={"/#don"}><Button className='h-14 text-lg'>{"Faire un don"}<ArrowRight size={20}/></Button></Link>
            </span>
            <Sheet>
                ...
                <SheetContent side={"left"}>
                    ...
                    <div role="list" className='flex flex-col'>
                        ...
                        <SheetClose asChild><Link href={"/#don"}><Button className='h-14 text-lg'>{"Faire un don"}<ArrowRight size={20}/></Button></Link></SheetClose>
                    </div>
                </SheetContent>
            </Sheet>
        </div>
