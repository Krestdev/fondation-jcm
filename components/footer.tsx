    ...
    <footer className="container-base xl:rounded-t-xl bg-slate-900 text-slate-50 py-10 sm:px-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
        <div className="flex flex-col gap-3 w-full">
          <img src="/logo-dark.png" className="h-20 w-auto object-contain object-left" />
      ...
      <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-400">{"Propulsé par "}<a href="https://krestdev.com" target="_blank" className="font-semibold hover:text-secondary transition-colors duration-300 ease-in-out">{"KrestDev"}</a></p>
        </div>
        <Link href={"/#don"}>
